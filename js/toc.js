(function ($) {
    $.fn.toc = function (options) {
        ...
        var render = {
            show: function () {
                output.find(settings.listType).hide().show(settings.showSpeed);
            },
            slideDown: function () {
                output.find(settings.listType).hide().slideDown(settings.showSpeed);
            },
            fadeIn: function () {
                output.find(settings.listType).hide().fadeIn(settings.showSpeed);
            },
            none: function () {
            }
        };
